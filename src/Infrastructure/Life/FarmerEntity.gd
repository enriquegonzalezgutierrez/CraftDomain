...
#              and body (farmer_body.png) with smart solid-color PBR fallback.
...
func _build_visual_representation() -> void:
	...
	# 1. Torso Robe (Loads farmer_body.png if exists)
	_create_box(_visual_root, Vector3(0.45, 0.9, 0.45), Vector3(0, 0.55, 0), robe_color, "farmer_body.png")
