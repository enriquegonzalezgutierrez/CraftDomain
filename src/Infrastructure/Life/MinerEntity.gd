# ==============================================================================
# Project: CraftDomain
# Description: Miner NPC physics controller with dynamic visual strategy injection.
#              SOLID COMPLIANCE: 
...
## Concrete Implementation (DIP): Injects the modular Miner Role ID into the strategy compiler
