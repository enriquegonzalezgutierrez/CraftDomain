...
#   collision vertices, and non-distorting UV mapping for a bottom slab.
...
# File: res://src/Domain/World/BottomSlabGeometry.gd
# ==============================================================================
...
# WINDING ORDER RESTORATION: Reverted to the original, stable game coordinates scaled to 0.5 height.
