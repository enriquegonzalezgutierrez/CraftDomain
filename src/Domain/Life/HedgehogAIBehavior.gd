# ==============================================================================
# Pathfile: res://src/Domain/Life/HedgehogAIBehavior.gd
# Description: Concrete AI behavior strategy implementing Goal-Oriented Action 
#              Planning (GOAP) for the Speedy Blue Hedgehog with high-speed
#              sprint dashes and agile obstacle avoidance.
# Author: Enrique González Gutiérrez
# Email: enrique.gonzalez.gutierrez@gmail.com
# ==============================================================================
class_name HedgehogAIBehavior
extends IAIBehavior
...
const SPEED_SPRINT: float = 6.8
const SPEED_PANIC: float = 8.5
...
func _setup_goap_profile() -> void:
	_setup_goals()
	_actions.append(HedgehogPanicAction.new())
	_actions.append(SuperSprintAction.new())
...
func _setup_goals() -> void:
	...
	var sprint_goal := GOAPGoal.new("HighSpeedDash", 2.0)
	sprint_goal.add_desired_state("is_sprinting", true)
	
	_goals.append_array([evade_goal, sprint_goal])
...
func get_active_state_name(host: Object) -> String:
	...
	if _active_plan.size() > 0:
		...
		if action_name == "SuperSprint": return "WANDERING"
		elif action_name == "HedgehogPanic": return "PANIC"
	return "WANDER"


# ==============================================================================
# INNER CLASSES: GOAP ACTIONS (High-speed hedgehog behaviors)
# ==============================================================================

class HedgehogPanicAction extends GOAPAction:
	func _init() -> void:
		super("HedgehogPanic", 1.0)
	...
	func execute_step(bb: AIBlackboard, _delta: float) -> bool:
		...
		var timer := bb.get_float("wander_timer")
		if timer <= 0.0:
			bb.set_memory("wander_timer", 3.0)
...
class SuperSprintAction extends GOAPAction:
	func _init() -> void:
		super("SuperSprint", 1.0)
		add_effect("is_sprinting", true)
	...
	func execute_step(bb: AIBlackboard, delta: float) -> bool:
		...
		VoxelKinematicService.apply_motion_vectors(host, ai, wander_dir, SPEED_SPRINT)
		return false
