# ==============================================================================
# Pathfile: res://src/Domain/Life/GuardModelBuilder.gd
# Description: Concrete strategy implementing the procedural voxel model 
#              sculptor for the Armored Guard Knight entity.
...
func build_model(
	...
	_sculpt_guard_armor(visual_component, body_bob_node)
	_sculpt_guard_helmet(visual_component, body_bob_node, skin_color)
	_sculpt_guard_sword(visual_component, body_bob_node)


func _sculpt_guard_armor(visual_component: Object, parent: Node3D) -> void:
	var steel_armor := Color(0.40, 0.40, 0.45)
	var iron_color := Color(0.55, 0.55, 0.60)
	
	visual_component.call("create_box", parent, Vector3(0.42, 0.15, 0.42), Vector3(0, 0.075, 0), steel_armor)
	visual_component.call("create_box", parent, Vector3(0.45, 0.75, 0.45), Vector3(0, 0.525, 0), steel_armor)
	visual_component.call("create_box", parent, Vector3(0.14, 0.24, 0.38), Vector3(-0.25, 0.75, 0), iron_color) # Pauldron L
	visual_component.call("create_box", parent, Vector3(0.14, 0.24, 0.38), Vector3(0.25, 0.75, 0), iron_color)  # Pauldron R


func _sculpt_guard_helmet(visual_component: Object, parent: Node3D, skin_color: Color) -> void:
	var steel_armor := Color(0.40, 0.40, 0.45)
	var iron_color := Color(0.55, 0.55, 0.60)
...
func _sculpt_guard_sword(visual_component: Object, parent: Node3D) -> void:
	var iron_color := Color(0.55, 0.55, 0.60)
