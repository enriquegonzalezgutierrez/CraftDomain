...
#              Planning (GOAP) for the Fluffy Sheep with smart wall navigation.
...
func _setup_goap_profile() -> void:
	...
	_actions.append(SheepWanderAction.new())
...
func _setup_goals() -> void:
	...
	var graze_goal := GOAPGoal.new("RegrowWool", 1.0)
...
func _initialize_agent(host: Object) -> void:
	if _blackboard == null:
		...
		if not host.has_meta(META_IS_FLUFFY):
...
# ==============================================================================
# INNER CLASSES: GOAP ACTIONS (Decoupled ovine behaviors)
# ==============================================================================
...
class SheepWanderAction extends GOAPAction:
	func _init() -> void:
		super("Wander", 1.0)
	...
	func execute_step(bb: AIBlackboard, delta: float) -> bool:
		...
		VoxelKinematicService.apply_motion_vectors(host, ai, wander_dir, SheepAIBehavior.SPEED_WANDER)
		return false
