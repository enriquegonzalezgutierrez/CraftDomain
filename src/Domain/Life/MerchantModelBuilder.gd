...
func build_model(
	...
	visual_component.call("create_box", body_bob_node, Vector3(0.45, 0.75, 0.45), Vector3(0, 0.525, 0), robe_color)
	visual_component.call("create_box", body_bob_node, Vector3(0.3, 0.5, 0.05), Vector3(0, 0.38, -0.23), apron_color) # Apron
	
	# Floating Zurrón (Leather pouch)
	visual_component.call("create_box", body_bob_node, Vector3(0.12, 0.18, 0.12), Vector3(-0.24, 0.38, -0.15), Color(0.35, 0.22, 0.15))
