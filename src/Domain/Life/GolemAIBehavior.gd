...
#              Planning (GOAP) for the Colossus Iron Golem with smart wall navigation.
...
class OverwatchPatrolAction extends GOAPAction:
	...
	func execute_step(bb: AIBlackboard, delta: float) -> bool:
		...
		VoxelKinematicService.apply_motion_vectors(host, ai, wander_dir, GolemAIBehavior.SPEED_PATROL)
		return false
