...
# SOLID COMPLIANCE:
# - Single Responsibility Principle (SRP): Exclusively manages the properties 
#   of a single dialogue option.
# - Open-Closed Principle (OCP): Supports extensions via optional requirements 
#   (quests, recipes) without modifying the core structure.
